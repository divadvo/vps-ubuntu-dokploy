...
echo ""
printf "  $(gum style --foreground 240 '1')  Set hostname + create admin user + strong password policy\n"
...
NEW_HOSTNAME=$(gum input --placeholder "Hostname (letters, numbers, hyphens)" --prompt "> " --prompt.foreground 6)
